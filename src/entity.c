...
Entity_manager_t Entity_manager_make()
{
...
void Entity_render(Entity_manager_t manager)
{
    ...
    {
        Sprite_sheet_render_sprite(entity_iterator->sprite_sheet, entity_iterator->sprite_index, entity_iterator->coordinates.x, entity_iterator->coordinates.y);
...
void Entity_manager_new_entity(Entity_manager_t manager, Sprite_sheet_t sprite_sheet, uint8_t sprite_index, uint8_t x, uint8_t y)
{
    Entity_manager_free_future_entitys(manager);
